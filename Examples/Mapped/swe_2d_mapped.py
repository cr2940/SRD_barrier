...
def setup(kernel_language='Fortran', use_petsc=False, outdir='./_output_Lmapped',
    ...
    state.grid.add_gauges([(0.5,0.76),(0.5,0.39)])#(0.5,0.789),(0.5,0.788),(0.5,0.783),(0.5,0.75),(0.5,0.74),(0.5,0.73),(0.5,0.72),(0.5,0.41),(0.5,0.42),(0.5,0.43),(0.5,0.45),(0.5,0.35),(0.5,0.25),(0.5,0.15)])#,(0.5,0.82),(0.5,0.83),(0.5,0.87),(0.5,0.869),(0.5,0.861),(0.5,0.545),(0.5,0.863),(0.5,0.864),(0.5,0.865),(0.5,0.866),(0.5,0.867),(0.5,0.868),(0.5,0.94),(0.5,0.95),(0.5,0.96),(0.5,0.97),(0.5,0.98)])#,(0.25,0.375),(0.25,0.73),(0.75,0.73),(0.75,0.375)])#,(0.24,0.76),(0.375,0.625),(0.5,0.5),(0.625,0.375),(0.75,0.25),(0.875,0.125)])
    ...
    claw.run()
    plot(setplot=setplot,outdir='./_output_Lmapped',plotdir='./_plots_mapped',iplot=False,htmlplot=True)
